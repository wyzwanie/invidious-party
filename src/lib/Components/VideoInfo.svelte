...
{/if}
    <div class="info">
        <div class="titleBar">
            <div class="left">
                <div class="title">{videoAPI.title}</div>
                <div class="viewCount">
                    ...
                    <span>{videoAPI.viewCount.toLocaleString()} • Published: {howLongAgo(videoAPI.published)} - <span style="font-size: 90%">{new Date(videoAPI.published*1000).toLocaleString()}</span></span>
                </div>
            </div>
            <div class="right">
                {#if !videoAPI.likeCount}
        ...
        <div class="authorBar">
            ...
            <div class="subcount">{videoAPI.subCountText}</div>
        </div>
    </div>
{:else}
...loading...
