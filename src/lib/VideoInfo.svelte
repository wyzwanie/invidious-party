    ...
    <div class="titleBar">
        <div class="left">
            ...
            <div class="viewCount">
                ...
                <span>{videoAPI.viewCount.toLocaleString()} • Published: {videoAPI.publishedText} - <span style="font-size: 90%">{new Date(videoAPI.published*1000).toLocaleString()}</span></span>
            </div>
        </div>
        <div class="right">
