...
{:then videoAPI}
    <div class="top">
        <div class="video">
            {#if $chosen}
                <Video chosen={$chosen} {videoAPI} on:error={() => $chosen = chooseInstance($store.instances)} />
            {/if}
        </div>
        <div class="chat">
            <Chat roomID={videoID} />
    ...
    <div class="bottom">
        <div class="info">
            <VideoInfo chosen={$chosen} {videoAPI} on:rotate={() => $chosen = chooseInstance($store.instances)} />
        </div>
        <div class="related">
